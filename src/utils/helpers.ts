...
import { 
  ...
  Pill, Leaf, Sprout, Heart, Music, BookOpen, Car, Baby, FlaskConical
} from 'lucide-react';
...
const SUFFIXES: Record<ContextType, string[]> = {
  ...
  home: ["Cozy Cage", "Rumah Meowthetic", "Vibes Pinterest", "Bikin Betah", "Dekorasi Lucu"],
  ...
  general: ["Gemoy Parah", "Racun MeowRacun", "Wajib Punya", "Lucu Banget", "Auto Checkout", "Si Paling Viral"]
};
...
const DESCRIPTIONS: Record<ContextType, string[]> = {
  ...
  home: ["Bikin kamarmu se-cozy kardus kucing. Meowthetic dan bikin betah seharian.", "Dekorasi lucu yang bikin rumah makin homey. Tamu pasti nanya beli dimana."],
  ...
  stationery: ["Alat tempur buat kerja atau belajar. Bikin meja makin meowthetic.", "Nulis jadi makin semangat pake ini. Ide ngalir terus!"],
  ...
  general: ["Barang random tapi berfaedah. Lucu banget, gak nahan buat checkout!", "MeowRacun approved! Barang ini ratingnya 1000/10."]
};
