...
const QUOTES = [
  ...
  "Belanja adalah obat stress terbaik (kata kucing).",
  "Hidup itu singkat, checkout sekarang sebelum nyesel.",
  "Kerja keras bagai kuda, belanja bagai majikan.",
  "Dompet boncos demi kebahagiaan batin.",
];
    ...
    <footer className="mt-12 pb-8 px-4 text-center">
      <div className="max-w-2xl mx-auto border-t border-gray-100 dark:border-gray-800 pt-8">
        ...
        <p className="text-xs text-gray-400 flex items-center justify-center gap-1 mt-4">
          Dibuat dengan <Heart className="w-3 h-3 text-red-400 fill-current animate-pulse" /> dan 🐾 oleh Majikan
        </p>
